    ...
    return (
        <footer className="mt-20">
            ...
            <div className="items-center justify-between sm:flex">
                ...
                <div className="mt-10 py-8 px-4 border-t border-gray-800 items-center justify-between sm:flex">
                
                    <p className="text-gray-400 text-center">© 2024 QuickMed Inc by Adain. All rights reserved.</p>
