...
const Features = () => {
    ...
    const featuresList = [
        ...
        },
        {
            ...
            title: "Powerful Dashboard Optimization",
        ...
        },
        {
            ...
            title: "Personalized Staff and Administrators Experiences",
        ...
        },
        {
            ...
            title: "Automated Forensic Testing",
        ...
        },
        {
            ...
            title: "Staff WorkSpace Segmentation",
        ...
        },
        {
            ...
            title: "App Users and Sales Integration",
    ...
    return (
        <SectionWrapper>
            <div id="features" className="custom-screen px-4 text-gray-300">
                <LayoutEffect
                ...
                >
                    <div className="max-w-xl mx-auto text-center">
                        <h2 className="text-gray-50 text-3xl font-semibold sm:text-4xl">
                            Start Managing Team Worskpace and QuickMed App users Analytics efficiently
                        </h2>
                        <p className="mt-3">
