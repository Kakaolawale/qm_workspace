...
import NavHeader from '@/app/ui/home/navheader/navheader'
...
const Navbar = () => {
    ...
    const navigation = [
        { name: "QuickMed", href: "/#features" },
        { name: "QuickMed Team WorkSpace", href: "/quickmedteam" },
        { name: "Health Service Providers", href: "/serviceproviders" },
        { name: "Adain", href: "/#faqs" },
        { name: "APIs", href: "/#apis" },
    ...
    return (
        <header className='relative'>
            <div className="custom-screen pr-6 md:hidden">
                <NavHeader menuBtnEl={menuBtnEl} state={state} onClick={() => setState(!state)} />
            </div>
            <nav className={`pb-5 md:text-sm md:static md:block ${state ? "bg-gray-900 absolute px-4 z-20 top-0 inset-x-0 rounded-b-2xl shadow-xl md:bg-gray-900" : "hidden"}`}>
