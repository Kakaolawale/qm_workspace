            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-200">
                <div className="space-y-2 py-6">
                  {navigation.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-200 hover:bg-orange-600"
                    >
                      {item.name}
                    </a>
                  ))}
                ...
                <div className="py-6">
                  <a
                    href="./login"
                    className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-orange-600 hover:bg-gray-50"
                  >
                    Log in
                  </a>
                </div>
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <a href="#" className="text-sm rounded-md px-3.5 py-2.5 bg-red-600 font-semibold leading-6 hover:bg-orange-600 text-white">
